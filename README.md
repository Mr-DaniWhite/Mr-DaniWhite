<div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji'; color: #c9d1d9; background-color: #0d1117; padding: 10px;">
  ...
  <p align="right" style="font-size: 0.9em; color: #8b949e; font-weight: 500; margin: 0 0 20px 0;">
    📍 Madrid, Spain &nbsp;&bull;&nbsp; 💼 Senior Infrastructure Security Architect
  </p>

  <p style="font-size: 1.1em; line-height: 1.7; color: #8b949e; margin: 0 0 30px 0;">
  ...
  <table width="100%" style="border-collapse: collapse; border: none; background: none;">
    <tr style="border: none; background: none;">
      ...
      <td width="32%" style="vertical-align: top; background-color: #0d1117; border: 1px solid #30363d; border-radius: 6px; padding: 16px;">
        ...
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
          <img src="https://img.shields.io/badge/CloudVision-007ACC?style=flat-square" alt="CloudVision"> <strong>Arista CVP:</strong> Automated configlets, change control & state telemetry.
        </p>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
      ...
      <td width="32%" style="vertical-align: top; background-color: #0d1117; border: 1px solid #30363d; border-radius: 6px; padding: 16px;">
        <h3 style="color: #f0f6fc; font-size: 1.05em; margin: 0 0 14px 0; font-weight: 600;">Fortinet Enterprise Security</h3>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
          <img src="https://img.shields.io/badge/FortiGate_NGFW-EE3124?style=flat-square&logo=fortinet&logoColor=white" alt="FortiGate NGFW"> <strong>FortiGate Infrastructure:</strong> High-Availability clustering, multi-tenant VDOMs & hardware SSL inspection.
        </p>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
          <img src="https://img.shields.io/badge/FortiSwitch_Fabric-EE3124?style=flat-square" alt="FortiSwitch Fabric"> <strong>FortiSwitch & FortiAP:</strong> Secure access layers under unified FortiLink software management.
        </p>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
          <img src="https://img.shields.io/badge/Palo_Alto-ED1C24?style=flat-square&logo=paloaltonetworks&logoColor=white" alt="Palo Alto"> <strong>Palo Alto Networks:</strong> Zero Trust architecture orchestration & Panorama service policies.
        </p>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0;">
          <img src="https://img.shields.io/badge/Zscaler_ZTNA-0072C6?style=flat-square" alt="Zscaler ZTNA"> <strong>Zscaler SSE:</strong> Cloud-delivered perimeter protection via ZPA & ZIA secure edge gateways.
        </p>
      </td>
      ...
      <td width="32%" style="vertical-align: top; background-color: #0d1117; border: 1px solid #30363d; border-radius: 6px; padding: 16px;">
        <h3 style="color: #f0f6fc; font-size: 1.05em; margin: 0 0 14px 0; font-weight: 600;">NetDevOps & Automation</h3>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
  ...
  <table width="100%" style="border-collapse: collapse; border: none; background: none;">
    <tr style="border: none; background: none;">
      ...
      <td width="32%" style="vertical-align: top; background-color: #0d1117; border: 1px solid #30363d; border-radius: 6px; padding: 16px;">
        <h3 style="color: #f0f6fc; font-size: 1.05em; margin: 0 0 14px 0; font-weight: 600;">Hybrid & Cloud Networking</h3>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
          <img src="https://img.shields.io/badge/AWS_Transit_Gateway-FF9900?style=flat-square&logo=amazon-aws&logoColor=white" alt="AWS Transit"> <strong>AWS Transit Infrastructure:</strong> Enterprise account Transit Gateways & redundant Direct Connect pipelines.
        </p>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
          <img src="https://img.shields.io/badge/Azure_Virtual_WAN-0089D6?style=flat-square&logo=microsoft-azure&logoColor=white" alt="Azure VWAN"> <strong>Azure Cloud Routing:</strong> Virtual WAN routing architectures, hub-spoke secure segmentation & ExpressRoute overlays.
        </p>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0;">
          <img src="https://img.shields.io/badge/Google_Cloud-4285F4?style=flat-square&logo=google-cloud&logoColor=white" alt="GCP"> <strong>GCP Interconnect:</strong> Cloud Routers, Shared VPC architectures & cross-environment dynamic BGP paths.
        </p>
      </td>
      ...
      <td width="32%" style="vertical-align: top; background-color: #0d1117; border: 1px solid #30363d; border-radius: 6px; padding: 16px;">
        ...
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0;">
          <img src="https://img.shields.io/badge/Splunk-000000?style=flat-square&logo=splunk&logoColor=white" alt="Splunk"> <strong>Log Architecture:</strong> Splunk Core log parsing, advanced dashboard design & proactive infrastructure metrics.
        </p>
      </td>
      ...
      <td width="32%" style="vertical-align: top; background-color: #0d1117; border: 1px solid #30363d; border-radius: 6px; padding: 16px;">
        <h3 style="color: #f0f6fc; font-size: 1.05em; margin: 0 0 14px 0; font-weight: 600;">Fortinet Security Fabric Extended</h3>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0 0 10px 0;">
          <img src="https://img.shields.io/badge/FortiAnalyzer-EE3124?style=flat-square" alt="FortiAnalyzer"> <strong>FortiAnalyzer & FortiSIEM:</strong> Enterprise log management, data aggregation & cross-vendor event correlation.
        </p>
        <p style="font-size: 0.9em; line-height: 1.5; margin: 0;">
          <img src="https://img.shields.io/badge/Identity_/_Access-EE3124?style=flat-square" alt="Identity/Access"> <strong>Access Engineering:</strong> FortiAuthenticator directory interfaces, FortiToken MFA maps & FortiEDR endpoints.
        </p>
      </td>
